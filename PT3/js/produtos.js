...
/*Limpa a tela que o cliente preenche com os dados */
/* function limpaTelaConfirmaPedido(){
    for(var i = 1; i <= 10; i++){
        var idElem = "elementoForm" + i;
...
/* var texto2 = carrinho.produto[0].id;
        var hElement2 = document.createElement("H3");
        var tElement2 = document.createTextNode(texto2);
        hElement2.appendChild(tElement2);
        document.getElementById('resumoDadosCliente').appendChild(hElement2); */
